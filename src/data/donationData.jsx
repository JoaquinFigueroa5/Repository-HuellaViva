...
export const MEDICATIONS = [
  {
    ...
    icon: <FaShieldAlt size={24} color="#00B8CC" />,
    color: "#00B8CC",
    items: [
  ...
  },
  {
    ...
    icon: <FaPills size={24} color="#00B8CC" />,
    color: "#00B8CC",
    items: [
  ...
  },
  {
    ...
    icon: <FaEye size={24} color="#00B8CC" />,
    color: "#00B8CC",
    items: [
...
export const HYGIENE_PRODUCTS = [
  {
    ...
    icon: <FaDog size={24} color="#00B8CC" />,
    color: "#00B8CC",
    items: [
  ...
  },
  {
    ...
    icon: <FaSyringe size={24} color="#00B8CC" />,
    color: "#00B8CC",
    items: [
