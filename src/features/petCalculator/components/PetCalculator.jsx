        ...
        <div className="relative max-w-300 mx-auto">
          ...
          >
            ...
            <div className="flex gap-3 shrink-0 flex-wrap justify-center">
              <m.a
                href={`https://wa.me/50230603492?text=${encodeURIComponent(`¡Hola! Calculé que puedo gastar Q${monthlyTotal}/mes en una mascota. ¿Me orientan en el proceso de adopción?`)}`}
                target="_blank"
